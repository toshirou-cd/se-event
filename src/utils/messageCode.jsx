...
const receiveMessageCode = (messageCode) => {

   switch (messageCode) {
    case "U111":
      return "User not found or deleted";
    case messageCode === "U112":
      return " user info for add invalid";
    case messageCode === "U113":
      return " User email exist";
    case messageCode === "U114":
      return " Add user fail";
    case messageCode === "U115":
      return " User account inactivated";
    case messageCode === "U116":
      return " User account has been deleted";
    case messageCode === "U117":
      return " User storage not found";
    case messageCode === "U118":
      return " User mail not found";
    case "U119":
      return " Reset password for user fail";
    case "U120":
      return " User name exist";
    case "EVD111":
      return "Date start for join event is smaller datetime now or is too close to date time now";
    case "EVD112":
      return "Date end for join event is smaller date start join or is too close to date start join";
    case "EVD113":
      return "Date start event is smaller date end for join event or is too close to date end for join event";
    case "EVD114":
      return "Date end event is smaller date start event or is too close to date start event";
    case "EVD115":
    ...
    case "EV113":
      return "Get event fail";
    case "EV114":
      return "Update event fail";
    case "EV115":
      return "Delete event fail";
    case "EV116":
      return "Add event fail";
    case "EV117":
      return "Even plan not found";
    case "EV118":
      return "Even name is duplicated";
    case "EV119":
      return "Request add group event not contain any event";
    case "EV120":
    ...
    case "ER112":
      return "Add event request fail";
    case "ER113":
      return "No event request available";
    case "ER114":
      return "Get event request fail";
    case "ER115":
      return "Event request not found";
    case "ER116":
      return "update event request fail";
    case "ER117":
      return "Add group event request fail";
    case "EC111":
      return "Add event content fail";
    case "EC112":
      return "Event content not found";
    case "EC113":
      return "Delete event content fail";
    case "UE111":
      return "This is not time to register ! ";
    case "UE112":
      return "User event not found";
    case "UE113":
      return "Delete user in event failed";
    case "UE114":
      return "Get user event fail";
    case "UE115":
      return "No user event to display";
    case "GV111":
      return "Group event name is duplicated";
    case "GV112":
      return "Add group event fail";
    case "GV113":
      return "Group event not found";
    case "GV114":
      return "No group event to display";
    case "GV115":
      return "Get group event fail";
    case "GV116":
      return "Update group event fail";
    case "GV117":
      return "Delete group event fail";
    case "F113":
      return "File content is empty";
    case "R112":
      return "Update role fail";
    case "D111":
      return "Wrong format for date !";
    case "TA111":
      return "Wrong type or action to enter api";
    case "S113":
      return "Product Per Page of Current Page is blank or zero";
    case "S114":
      return "Name is required ! ";
    case "LK111":
      return "User has liked this post";
    case "LK112":
      return "Add like fail";
    case "LK113":
      return "Like not exist";
    case "LK114":
      return "Delete like fail";
    case "CM111":
      return "Get comment fail";
    case "CM112":
      return " Add comment fail";
    case "CM113":
      return "Comment not found";
    default:
      return "Action failed : Unexpected Errorr !";
  }
}
  export default receiveMessageCode
  ...
  /// </summary>
  // public const String DeleteEventFail = "EV115"; / <summary>
